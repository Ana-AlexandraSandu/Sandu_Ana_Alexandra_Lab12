...
namespace Sandu_Ana_Alexandra_Lab12.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Sandu_Ana_Alexandra_Lab12Context _context;

        public ShopListsController(Sandu_Ana_Alexandra_Lab12Context context)
        {
            _context = context;
        }
